            ...
            return <SwiperSlide key={index}>
              <div className="relative">
                ...
                <div className="flex justify-between items-center w-[352.5px] bg-gray-200 bg-opacity-40 p-5 absolute bottom-0">
                  <Link
                    to=""
                    className="text-[22px] font-medium leading-none hover:text-primary transition-all"
                  >
                    {cate.name}
                  </Link>
                  <Link
                    to=""
                    className="w-[45px] h-[45px] rounded-full bg-white hover:bg-black hover:text-white flex justify-center items-center"
                  >
                    <svg
