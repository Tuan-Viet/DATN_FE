                            ...
                            if (voucher.validTo == null) {
                                return (
                                    <SwiperSlide key={index}>
                                        ...
                                        <div
                                            className="divide-y divide-gray-200 rounded-2xl border  border-gray-300 shadow-sm w-[310px]"
                                            key={index}
                                        >
                                            <div className="p-6 sm:px-8">
                                                <h2 className="text-lg font-medium text-gray-900">
                                                    Giảm {voucher && voucher.type == "percent" ? <>{(voucher.discount)}%</> : <>{(voucher.discount).toLocaleString("vi-VN")}đ </>}
                                            ...
                                            <div className="p-2 sm:px-8 ">
                                                <ul className="mt-2 space-y-2 flex justify-between">
                                                    ...
                                                    >
                                                        ...
                                                        className="block rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-indigo-700 focus:outline-none focus:ring"
                                                        type="button"
