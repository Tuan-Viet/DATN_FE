      ...
      <div className="bg-[#242021] h-[36px] left-0 right-0">
        <div className="container text-white h-full flex justify-between items-center">
          <p className="text-[13px]">
            ...
            (9:00-21:00, Tất cả hàng tuần) <span className="mx-[10px]">|</span>{" "}
          ...
          <div className="flex items-center">
            ...
            <div className="relative">
              <Link to="">
                ...
                <span className="w-[20px] h-[20px] flex items-center justify-center rounded-full bg-red-600 text-white absolute top-[-5px] right-[-5px]">
                  1
                </span>
              </Link>
            </div>
